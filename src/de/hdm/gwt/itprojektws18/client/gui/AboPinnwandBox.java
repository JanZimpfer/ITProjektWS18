...
/**
 * Klasse, die es ermöglicht, einzelne Abonnements eines Nutzers zu erstellen,
 * die dessen Nutzername und Nickname beinhalten. Instanzen dieser Klasse werden
 * in der Klasse "AboBox" dargestellt.
 * 
 * @author NiklasFuchs
 *
 */
...
public class AboPinnwandBox extends HorizontalPanel {
	...
	public AboPinnwandBox(final Abonnement a) {
		...
		/**
		 * Hinzufügen von Clickhandler auf die Label, um auf die Pinnwand * des
		 * angeklickten Nutzers zu gelangen
		 * 
		 * @author NiklasFuchs
		 */
	...
	/**
	 * Nested Class für das Anzeigen der Pinnwand des abonnierten Nutzers,
